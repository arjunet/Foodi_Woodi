...
requirements = python3,kivy==2.3.0,kivymd==1.1.1,pillow==10.3.0,pyrebase4,requests,urllib3==1.26.15,oauth2client,httplib2,certifi,charset-normalizer,idna,cffi,Jinja2,jwcrypto,jws,pycryptodome,Pygments,PyJWT,pyparsing,python-jwt,rsa,pyasn1
